    ...
    <form onSubmit={handleSubmit} className="w-full max-w-lg space-y-4">
      <div className="relative">
        <input
          ...
          className="w-full px-4 py-4 text-sm bg-black border-2 border-green-500 rounded
                     text-green-500 placeholder-green-700 focus:outline-none focus:border-green-400
                     focus:shadow-[0_0_10px_#00ff00] transition-all font-mono uppercase"
          disabled={loading}
        />
      </div>
      ...
      <button
        type="submit"
        disabled={loading}
        className="w-full py-4 px-6 text-sm font-bold bg-green-500 border-2 border-green-400
                   rounded text-black hover:bg-green-400 hover:shadow-[0_0_20px_#00ff00]
                   disabled:opacity-50 disabled:cursor-not-allowed transition-all font-mono"
      >
        {loading ? (
